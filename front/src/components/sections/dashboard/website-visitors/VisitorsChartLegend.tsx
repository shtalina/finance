...
const VisitorsChartLegend = ({ data, toggleColor, handleToggleLegend }: LegendProps) => {
  ...
  if (toggleColor.organic && data.type === 'Utilities sector') {
    color = 'primary.main';
  } else if (toggleColor.social && data.type === 'Grocery sector') {
    color = 'secondary.lighter';
  } else if (toggleColor.direct && data.type === 'Transport sector') {
