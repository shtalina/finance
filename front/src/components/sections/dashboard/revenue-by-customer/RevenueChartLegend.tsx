...
const RevenueChartLegend = ({ data, toggleColor, handleLegendToggle }: LegendProps) => {
  ...
  if (toggleColor.currentClients && data.type === 'Utilities sector') {
    color = 'primary.main';
  } else if (toggleColor.subscribers && data.type === 'Grocery sector') {
    color = 'secondary.lighter';
  } else if (toggleColor.newCustomers && data.type === 'Transport sector') {
